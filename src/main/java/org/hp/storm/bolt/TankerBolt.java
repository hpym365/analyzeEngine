 ...
 */
public class TankerBolt extends BaseRichBolt {
    /**
    ...
    public void execute(Tuple input) {
        ...
        boolean feng = (boolean) map.get("feng");
        if (!feng) {
            warning = true;
        }

        System.out.println("Tanker 油罐运输车:" + "车牌号码:" + map.get("carNum") +
                " 时速:" + map.get("carSpeed") + " 当前状态:" + carState + " 油罐铅封:" + feng + "  车辆报警:" + warning);
    }
